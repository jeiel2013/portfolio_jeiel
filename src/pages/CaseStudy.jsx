      ...
      <div className="relative min-h-screen bg-[var(--bg-page)] text-[var(--text-primary)] antialiased">
        ...
        <div className="relative z-10">
          ...
          <main className="pt-40 px-6 text-center pb-24">
            ...
            <p className="text-[var(--text-secondary)] mb-8">{t.caseStudy.notFoundText}</p>
            <Link
              to="/projetos"
      ...
      <div className="relative z-10">
        ...
        <main className="pt-24">
          <section className="px-6 pb-8 max-w-3xl mx-auto text-center">
            ...
            <span className="text-[var(--accent)] font-mono text-xs tracking-widest mb-4 block">
              {t.caseStudy.eyebrow}
            </span>
            <h1 className="text-4xl md:text-5xl font-semibold tracking-tight text-[var(--text-primary)] mb-6">
              {project.title}
            </h1>
            ...
            <div className="flex flex-wrap gap-4 pt-4 border-t border-[var(--border-subtle)]">
              {project.demoUrl && (
                <a
                  ...
                  className="px-6 py-3 bg-[var(--accent)] text-[var(--accent-on)] text-sm font-semibold rounded-full hover:bg-[var(--accent-hover)] transition-all"
                >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-6 py-3 bg-[var(--surface-muted)] border border-[var(--border-subtle)] text-[var(--text-primary)] text-sm font-medium rounded-full hover:bg-[var(--surface-muted-hover)] transition-all"
              >
