            ...
            <div className="flex-1 flex flex-col justify-center space-y-8 pt-8">
              <div className="space-y-6 text-gray-700 leading-relaxed text-left">
                <p className="text-lg">
                  ...
                  <strong>TypeScript</strong>, <strong>NestJS</strong> e <strong>React</strong>.
                </p>

                <p className="text-lg">
                  Meu objetivo é transformar ideias em soluções práticas através
                  do código, sempre valorizando o trabalho em equipe e a troca
                  de conhecimentos.
                </p>

                <p className="text-lg">
                  No tempo livre, gosto de jogar e estar com amigos - atividades
                  que estimulam minha criatividade e pensamento estratégico.
                </p>
              </div>
